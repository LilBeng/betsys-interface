...
from betsys import BET_TYPE, BetCode
...
class _BetGroupBox(QGroupBox):
    def __init__(self, layout: callable, bet: BET_TYPE, all_events: bool = True, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
        self.setTitle(self.tr("Ставка"))

        self.setLayout(layout(bet, all_events))
...
class BetStackedLayout(QStackedLayout):
    def __init__(
        ...
        super().__init__(*args, **kwargs)
        self._over_under = _BetGroupBox(OverUnderLayout, bet, all_events, parent=parent_widget)
        self._both_to_score = _BetGroupBox(BothToScoreLayout, bet, all_events, parent=parent_widget)
        self._one_x_two = _BetGroupBox(OneXTwoLayout, bet, all_events, parent=parent_widget)
        self._double_chance = _BetGroupBox(DoubleChanceLayout, bet, all_events, parent=parent_widget)
        self._odd_or_even = _BetGroupBox(OddOrEvenLayout, bet, all_events, parent=parent_widget)
